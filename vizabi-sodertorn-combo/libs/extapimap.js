...
var LBubbleMap = Vizabi.Tool.extend("LBubbleMap", {
...
var LBubbleMapComponent = Vizabi.Component.extend("lbubblemap", {
  /**
  ...
  _setTooltip: function _setTooltip(d) {
    ...
    var KEY = this.KEY;
    if (d) {
      var tooltipText = this.values.label[d[KEY]];
      var x = void 0,
          y = void 0,
          offset = void 0;
      if (d.cLoc) {
...
var TopojsonLayer = MapLayer.extend({
  ...
  initMap: function initMap() {
    ...
    var _this = this;
    var shape_path = this.context.model.ui.map.topology.path || globals.ext_resources.host + globals.ext_resources.preloadPath + "world-50m.json";
...
exports.default = Vizabi.Class.extend({
  ...
  rescaleMap: function rescaleMap() {
    if (this.mapInstance) {
      ...
      var _this = this;
      this.mapRoot.attr("width", this.context.width + margin.left + margin.right).attr("height", this.context.height + margin.top + margin.bottom).style("position", "absolute").style("left", 0).style("right", 0).style("top", 0).style("bottom", 0);
